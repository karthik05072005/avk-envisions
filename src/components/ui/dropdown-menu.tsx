...
/** Shared enter/exit animation for every floating menu surface. */
const menuMotion = [
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[9rem] overflow-hidden rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-float',
      menuMotion,
      className,
    )}
    {...props}
...
const DropdownMenuItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Item> & {
    inset?: boolean;
    /** Styles the item as a destructive action (delete, revoke, suspend). */
    destructive?: boolean;
  }
