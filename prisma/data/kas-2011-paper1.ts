...
export const KAS_2011_PAPER1: PaperQuestion[] = [
  ...
  { n: 20, subject: 'Indian History', body: 'Northernmost known Harappan settlement in India:', options: ['Mandu', 'Harappa', 'Lothal', 'Ropar'], correct: 3 },
  ...
  // --- Q41–Q60 -------------------------------------------------------------
  { n: 41, subject: 'Indian History', body: '“Grand Old Man of India”', options: ['Lala Lajpat Rai', 'Bal Gangadhar Tilak', 'Surendranath Banerjee', 'Dadabhai Naoroji'], correct: 3 },
  { n: 42, subject: 'Indian History', body: 'Gandhi’s South African settlement', options: ['Phoenix Settlement', 'Sarvodaya Enclave', 'Young India', 'Unto the Last'], correct: 0 },
  { n: 43, subject: 'Indian History', body: 'Ashokan inscriptions — consider the following statements:\n\na. Most inscriptions were in Prakrit; northwest had Aramaic/Greek.\nb. Most Prakrit inscriptions used Brahmi.\nc. Some northwest inscriptions used Kharosthi.', options: ['a and b', 'Only a', 'b and c', 'a, b and c'], correct: 3 },
  { n: 44, subject: 'Indian History', body: 'Akbar’s land classification — consider the following:\n\na. Polaj\nb. Parauti\nc. Chachar\nd. Banjar', options: ['Only d', 'a and b', 'a, c and d', 'All above'], correct: 3 },
  { n: 45, subject: 'Indian History', body: '1857 — which pair is wrongly matched?', options: ['Kunwar Singh – Bihar', 'Nana Saheb – Nagpur', 'Birjis Qadr – Lucknow', 'Shah Mal – Barout'], correct: 1 },
  { n: 46, subject: 'Indian History', body: 'Two proper industrial cities during colonial period', options: ['Calcutta and Bombay', 'Bombay and Madras', 'Jamshedpur and Kanpur', 'Jamshedpur and Bombay'], correct: 0 },
  { n: 47, subject: 'Indian History', body: 'Who advised Gandhi to travel around British India for a year?', options: ['Bal Gangadhar Tilak', 'Mohammed Ali Jinnah', 'Gopal Krishna Gokhale', 'Lala Lajpat Rai'], correct: 2 },
  { n: 48, subject: 'Indian History', body: 'Jinnah’s Fourteen Points — consider the following:\n\na. Delhi Proposals\nb. Calcutta Amendments\nc. Separate Electorate\nd. Reservation for Muslims in Government service', options: ['a and b only', 'c and d only', 'a and d only', 'All above'], correct: 3, note: 'Keyed as "All above" in the source answer key.' },
  { n: 49, subject: 'Indian History', body: '“Devanampriya” and “Priyadarshi”', options: ['Harshavardhana', 'Mahavira', 'Gautama Buddha', 'Ashoka'], correct: 3 },
  { n: 50, subject: 'Indian History', body: 'Rowlatt Act — consider the following:\n\na. Greater/stricter press control\nb. Trial of political offenders by judges without juries\nc. Internment without trial\nd. Martial law throughout India', options: ['a and d', 'a, b and c', 'b, c and d', 'All'], correct: 1 },
  { n: 51, subject: 'Indian History', body: 'Belgaum Congress Session, 1924 — consider the following:\n\na. All India Khilafat Conference\nb. All India Hindu Mahasabha\nc. All India Non-Brahmin Conference\nd. All India Social Conference', options: ['a, b, d', 'b, c, d', 'a, c, d', 'All above'], correct: 3 },
  { n: 52, subject: 'Karnataka History', body: 'Influences of Karnataka Vaibhava — consider the following:\n\na. Cultural solidarity among Kannadigas\nb. Inspired freedom fighters\nc. Awareness of Karnataka’s glorious past', options: ['a and c', 'a and b', 'b and c', 'All above'], correct: 3 },
  { n: 53, subject: 'Indian History', body: 'Developments between 7th and 5th century BCE — consider the following:\n\na. Intellectual life was in ferment\nb. Old tribal structure was disintegrating\nc. Smaller regional kingdoms had disappeared', options: ['a and b', 'b and c', 'a and c', 'All above'], correct: 0 },
  { n: 54, subject: 'Indian History', body: 'Activities in the “constitutional phase” of the National Movement — consider the following:\n\na. Promotion of Khadi\nb. Non-Cooperation Movement\nc. Salt Satyagraha\nd. Struggle against untouchability', options: ['a and d', 'a and c', 'b and d', 'c and d'], correct: 0 },
  { n: 55, subject: 'Indian History', body: 'Facts known to Aryabhata — consider the following:\n\na. Earth moves round the Sun\nb. Reasons for eclipses\nc. Stars reflected Sun’s light\nd. Planets moved in elliptical paths around Sun', options: ['a, b, c', 'b, c, d', 'a, c, d', 'a, b, d'], correct: 0 },
  ...
  { n: 75, subject: 'Indian History', body: 'Freedom fighter who worked for revival of village/cottage industries', options: ['Rajkumari Amrit Kaur', 'Sushila Nayar', 'Vijayalakshmi Pandit', 'Kamaladevi Chattopadhyay'], correct: 3 },
  ...
  { n: 83, subject: 'Karnataka History', body: 'Justice Somashekar Committee investigated:', options: ['Attack on churches', 'Denotification of land', 'Illegal mining', 'BPL-card irregularities'], correct: 2 },
