...
async function seedContent(authorId: string) {
  ...
  const posts = [
    ...
    },
    {
      ...
      content:
        '<p>With two marks awarded and 0.5 deducted, a blind guess between four options is very slightly in your favour: you win 2 marks a quarter of the time and lose 0.5 marks the other three quarters, which averages out to +0.125 marks a question.</p><h2>The rule that follows</h2><p>Because the penalty is a quarter of the marks rather than a third, pure guessing is not punished into break-even. Eliminate even one option and it becomes clearly worth doing. Eliminate two and it is not really a guess any more.</p><h2>Where students go wrong</h2><p>Some leave everything they are unsure about, which quietly costs marks they could have earned. Others attempt everything, which is defensible mathematically but eats the time they needed for questions they could actually solve.</p><p>The real constraint is almost always time, not the marking scheme.</p>',
    },
  ];
